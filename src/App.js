...
function App() {
    ...
    console.log( Math.ceil(countBook / maxResults))

    let countPage =  Math.ceil(countBook / maxResults);
    ...
    const searchBookQuery = () => {
        axios
            ...
            .then((res) => {
                setCountBook(res.data.totalItems)
    ...
    return (
        <div className="wrapper">
            ...
            <Sort handleFuncSort={handleSort} list={list} sort={sort}/>
